<template>
    <div id="about" class="min-w-[240px] | w-[240px] h-[300px] lg:w-[300px] lg:h-[360px] xl:w-[340px] xl:h-[380px] 2xl:w-[350px] 2xl:h-[420px] | snap-center
    flex flex-col overflow-hidden | group | rounded-t-lg | bg-MQ_dark bg-opacity-75 hover:bg-opacity-60 | drop-shadow-md hover:drop-shadow-MQ | transition-all duration-500">
        ...
        <div class="px-4 pt-2 pb-4 grow flex flex-col">
            <div class="w-full text-MQ_red text-xs"> {{ availability }} </div>
            <div class="text-xl lg:text-2xl xl:text-2xl 2xl:text-3xl | w-full text-slate-300 group-hover:text-slate-200 font-bold pt-1 uppercase | transition-all duration-500"> {{title}} </div>
        </div>

        <div class="px-4 h-full flex flex-col overflow-scroll">
            <div class="text-sm | w-full text-slate-400 group-hover:text-slate-300 | text-justify grow | transition-all duration-500"> 
                {{ description }}
            </div>
        </div>
