                ...
                <div class="text-2xl text-MQ_red flex justify-center items-end gap-2"> 
                    ...
                    <i @click="showPreviousUsername = !showPreviousUsername" :class="showPreviousUsername ? '-scale-100' : ''"
                        ...
                        <div @mouseleave ="showPreviousUsername = false" v-if="showPreviousUsername" 
                            ...
                            <div class="cursor-pointer hover:text-MQ_red">- UserName 1</div>
                            <div class="cursor-pointer hover:text-MQ_red">- uSeRnAmE 2</div>
                            <div class="cursor-pointer hover:text-MQ_red">- uSERnAME 3</div>
                        </div>
                    </i>
                </div>
                <div class="text-MQ_light text-sm"> Hi, I am zuza. Nice to meet you! </div>
            </div>
